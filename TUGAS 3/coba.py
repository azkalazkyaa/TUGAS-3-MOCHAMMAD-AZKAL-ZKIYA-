...
new_metadata = {'/Title': 'Sejarah Digital Forensik', '/Author': 'AZKAL', '/Subject': 'New Subject'}
message = " Desain dan Implementasi Sistem Informasi Usaha Mikro Kecil Menengah dan Pariwisata Desa Tambak Kalisogo"
first_page_image_path = 'SBY.png'
